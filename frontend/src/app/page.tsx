      ...
      <main className="pt-24 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <section className="text-center mb-24">
          ...
          >
            ...
            <h1 className="font-cormorant text-7xl md:text-7xl font-light tracking-tight mb-8"
        ...
        <section id="collection" className="mb-24">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 mb-12">
            <div>
              <h2 className="font-outfit text-2xl font-bold uppercase tracking-wider" style={{ color: "var(--text-primary)" }}>
                The Collection
              </h2>
        ...
        <section id="studio">
          <div className="flex justify-center mb-8">
            <div className="px-4 py-1 rounded-full text-[10px] font-bold uppercase tracking-[0.3em]"
                 style={{ background: "var(--surface-secondary)", border: "1px solid var(--border)", color: "var(--text-tertiary)" }}>
              Studio Experience
            </div>
          </div>
